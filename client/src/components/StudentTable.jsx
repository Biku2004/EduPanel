...
const AddedStudentTable = ({
  ...
  // Ensure selectedCourse is never null
  const safeSelectedCourse = selectedCourse || '';
  ...
  const filteredStudents = students.filter((student) => {
    const matchesCourse = safeSelectedCourse
      ? student.course === safeSelectedCourse
      : true;
  ...
  return (
    <div className="container mx-auto bg-white p-6 rounded-lg shadow dark:bg-gray-800 dark:text-white mt-6">
      {isLoading && <Loader />}
      ...
      <div className="flex flex-wrap gap-4 mb-4 dark:bg-gray-800 dark:text-white">
        ...
        />
        <select
          value={safeSelectedCourse} // Using the safe value
